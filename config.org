...
(use-package keycast
  ...
  (set-face-attribute 'keycast-key nil :height 0.7)
  (set-face-attribute 'keycast-command nil :height 0.6)
  (keycast-mode 1))
#+end_src
...
(use-package consult
  ...
  ;; https://github.com/raxod502/selectrum/issues/425#issuecomment-777520569
 ;; [[file:straight/repos/selectrum/selectrum.el::nil str))]]
  (set-face-attribute 'selectrum-current-candidate nil :background (modus-themes-color 'bg-special-warm))
...
(use-package mini-frame
  ...
  (setq mini-frame-background-color-function #'(lambda () (modus-themes-color 'bg-special-cold)))
