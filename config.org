...
(use-package project
  ...
  (setq project-switch-commands '((project-find-file "Find file") (diego/open-project-readme "README.md")(consult-ripgrep "Ripgrep")))
  :bind (:map
         project-prefix-map
...
(defun diego/dev ()
  ...
  (diego/compile
   (concat
    "/opt/dev/bin/dev "
    (completing-read "Dev command: " '(up down build test style)))))

(defun diego/dev-project ()
  "Runs a dev command from the project defined commands."
  (interactive)
  (compilation-start
   (concat "/opt/dev/bin/dev "
           (completing-read "Project Dev Command: "
                            (split-string
