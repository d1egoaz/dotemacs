...
(use-package vertico
  ...
  ;;:straight (vertico
  ;; :type git :host github :repo "minad/vertico"
  ...
  (defun +completion-category-highlight-files (cand)
    (let ((len (length cand)))
      (when (and (> len 0) (eq (aref cand (1- len)) ?/))
        (add-face-text-property 0 len 'dired-directory 'append cand)) cand))
...
(use-package kubel
  ...
  ;; :load-path "/Users/diegoalvarez/.emacs.d/straight/repos/kubel/kubel.el"
  :load-path "/Users/diegoalvarez/.emacs.d/straight/repos/kubel"
  ;; :load-path "/Users/diegoalvarez/code/oss/kubel"
  ;; :straight (kubel :host github :repo "abrochard/kubel")
  :config
