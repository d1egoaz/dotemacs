...
(use-package orderless
  ...
  (setq orderless-matching-styles '(orderless-regexp orderless-strict-initialism))
  ;; (setq orderless-matching-styles '(orderless-regexp orderless-strict-leading-initialism))

  (setq orderless-style-dispatchers '(without-if-bang diego/orderless-initialism-dispatcher))
...
(defun diego/dev-run (cmd)
  "Ask for a dev command to run."
  (interactive "sEnter dev command: ")
  (diego/compile (concat "/opt/dev/bin/dev " cmd) t))

(defun diego/dev ()
  "Runs a dev command."
  (interactive)
  (diego/compile (concat "/opt/dev/bin/dev " (completing-read "Dev command:" '(up down build test))) t))
...
- [[https://github.com/syl20bnr/spacemacs/][Spacemacs]] (This is where my Emacs journey began)
- [[https://github.com/hlissner/doom-emacs/][Doom Emacs]] (Where my Emacs skill improved)
- [[https://gitlab.com/protesilaos/dotfiles/-/blob/master/emacs/.emacs.d/prot-emacs.org][Protesilaos Stavrou]] (Where I learned to appreciate vanilla Emacs)
