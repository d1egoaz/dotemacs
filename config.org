...
;;;; Indicators for `tab-bar-format' --- EXPERIMENTAL
  ...
  (defun diego-tab-format-vc ()
    ...
    `((global menu-item ,(propertize (concat vc-mode " ") 'face '(:background "#fef2ea" :foreground "#813e00" :height 0.9 :weight 'bold)) ignore)))
...
#+begin_src elisp
(use-package kubel
  :straight (kubel :host github :repo "d1egoaz/kubel" :branch "origin/master")
  :config
