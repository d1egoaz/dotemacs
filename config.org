...
;;;; Indicators for `tab-bar-format' --- EXPERIMENTAL
  ...
  (defun diego--tab-insert-icon (name)
    `((global menu-item ,(propertize (concat " " (all-the-icons-octicon name)) 'face '(modus-themes-subtle-magenta :height 0.7 :family "github-octicons")) ignore)))
  ...
  (defun diego-tab-format-vc ()
    ...
    `((global menu-item ,(propertize (string-trim-right (format-mode-line vc-mode)) 'face '(modus-themes-subtle-magenta :height 0.7)) ignore)))
  ...
  (defun diego-tab-format-buffer-id ()
    ...
    `((global menu-item ,(propertize (format "[%s]"
                                     ...
                                     'face '(modus-themes-active-blue :height 0.8)) ignore)))
