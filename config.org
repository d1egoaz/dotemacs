...
(use-package modus-themes
  ...
  (defun diego--improve-tabs-color ()
    (require 'tab-line)
    (set-face-attribute 'tab-bar-tab nil :background "#bfd9ff" :foreground "#002f88" :weight 'bold)
    (set-face-attribute 'tab-line-tab nil :background "#e5cfef" :foreground "black" :weight 'normal)
    (set-face-attribute 'tab-line-tab-modified nil :foreground "#7f002f" :weight 'normal))
...
;;;; Indicators for `tab-bar-format' --- EXPERIMENTAL
  ...
  (defun diego-tab-format-buffer-id ()
    ...
    `((global menu-item ,(propertize (if (and buffer-file-truename (not (file-remote-p buffer-file-truename)))
                                         (concat " File: ["
                                     ...
                                     'face '(:background "#c4ede0" :foreground "#184034" :height 0.9 :weight bold)) ignore)))
...
(use-package pulse
  :straight (:type built-in)
  :config
  (set-face-attribute 'pulse-highlight-start-face nil :background (modus-themes-color 'cyan-intense-bg))
  ...
  (dolist (command '(
                     evil-scroll-line-to-top evil-scroll-line-to-bottom evil-scroll-line-to-center scroll-up scroll-down
                     recenter-top-bottom other-window evil-scroll-down evil-scroll-up evil-window-left evil-window-right
                     evil-avy-goto-line evil-window-split windmove-up windmove-down windmove-left windmove-right
                     delete-window kill-current-buffer))
