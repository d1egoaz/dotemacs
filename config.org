...
- [[#pending-tasks-611][Pending tasks]]
...
(use-package project
  ...
  (setq project-switch-commands '((project-find-file "Find file") (diego/open-project-readme "README.md")))
  :bind (:map
         project-prefix-map
...
(defun diego/dev ()
  "Runs a dev command."
  (interactive)
  (diego/compile (concat "/opt/dev/bin/dev " (completing-read "Dev command:" '(up down build test style)))))
